...
class MultiBoxMetric(mx.metric.EvalMetric):
    ...
    def update(self, labels, preds):
        ...
        rcnn_FGA_cls_target = preds[6].asnumpy()
        rcnn_FGA_reg_target = preds[7].asnumpy()
        ...
        rpn_loc_target = preds[8].asnumpy()
        ...
        rpn_rois = preds[9].asnumpy()
        rpn_scores = preds[10].asnumpy()
        rpn_cids = preds[11].asnumpy()
