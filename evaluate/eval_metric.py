...
from MultiBoxDetection import BB8MultiBoxDetection, RCNNFGABB8MultiBoxDetection, RCNNOffsetBB8MultiBoxDetection, MaskRCNNKeypointBB8MultiBoxDetection
...
class PoseMetric_offset(mx.metric.EvalMetric):
    """Calculate metrics for 6D pose estimation """
    def __init__(self, classes, LINEMOD_path, eps=1e-8):
        super(PoseMetric_offset, self).__init__('Pose')
        self.eps = eps
        self.num = 2
        self.ovp_thresh = 0.5
        self.use_difficult = False
